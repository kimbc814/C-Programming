...
void TF_base_link_base_link_map(const Point2D* kBase_link_Point2d, Point2D* p_Base_link_map_point2d, const Pose2D* kBase_link_origin) {
	...
	p_Base_link_map_point2d->x = (g_Rotation_matrix[0][0] * kBase_link_Point2d->x) + (g_Rotation_matrix[0][1] * kBase_link_Point2d->y);
	p_Base_link_map_point2d->y = (g_Rotation_matrix[1][0] * kBase_link_Point2d->x) + (g_Rotation_matrix[1][1] * kBase_link_Point2d->y);
}
//병진
void TF_base_link_map_map(Point2D* p_base_link_map_2d, const Pose2D* base_link_origin) {

	p_base_link_map_2d->x += (base_link_origin->x);
	p_base_link_map_2d->y += (base_link_origin->y);
}

//통합
void TF_map_base_link( const Point2D* kbase_link_Point2d, Point2D* p_Base_link_map_point2d, const Pose2D* kBase_link_origin) {
...
//병진
void TF_map_base_link_map(Point2D* p_base_link_map_2d, const Pose2D* base_link_origin) {
...
void TF_base_link_map_base_link( Point2D* p_Base_link_Point2d,const Point2D* kbase_link_map_point2d, const Pose2D* kBase_link_origin) {
	...
	p_Base_link_Point2d->x = (g_Rotation_matrix_inverse[0][0] * kbase_link_map_point2d->x) + (g_Rotation_matrix_inverse[0][1] * kbase_link_map_point2d->y);
	p_Base_link_Point2d->y = (g_Rotation_matrix_inverse[1][0] * kbase_link_map_point2d->x) + (g_Rotation_matrix_inverse[1][1] * kbase_link_map_point2d->y);


}
//통합
void TF_base_link_map(Point2D* p_Base_link_Point2d, Point2D* p_base_link_map_point2d, const Pose2D* kBase_link_origin) {
